export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 font-sans">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md shadow-sm z-10">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-bold text-gray-900">Sowmya Vunnam</h1>
      ...
      <section id="about" className="pt-24 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-6xl font-extrabold text-gray-900 mb-4 bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
            Sowmya Vunnam
          </h1>
          <h2 className="text-2xl text-gray-600 mb-8 font-light">Strategy and Analytics Consultant</h2>
      ...
      <section id="skills" className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl font-bold text-gray-900 mb-16 text-center">Skills</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-2xl font-semibold text-gray-800 mb-6">Tools & Languages</h4>
              <div className="space-y-3">
                {['SQL', 'Python', 'Stata', 'Power BI', 'MS Excel (Advanced)', 'Google Workspace'].map((skill) => (
                  <span key={skill} className="inline-block bg-white px-4 py-2 rounded-full text-sm font-medium text-gray-700 mr-2 mb-2 shadow-sm">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-2xl font-semibold text-gray-800 mb-6">Data Analysis</h4>
              <div className="space-y-3">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-2xl font-semibold text-gray-800 mb-6">Core Competencies</h4>
              <div className="space-y-3">
      ...
      <section id="experience" className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl font-bold text-gray-900 mb-16 text-center">Experience</h3>
          <div className="space-y-12">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-start">
                <div className="w-4 h-4 bg-blue-500 rounded-full mt-2 mr-6 flex-shrink-0"></div>
                <div className="flex-1">
                  <h4 className="text-2xl font-semibold text-gray-800 mb-2">Strategy and Analytics Consultant</h4>
                  <p className="text-gray-600 mb-6 font-medium">Aug. 2025 – Present | Pranik (Mondee Group), Hyderabad, India</p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <h4 className="text-2xl font-semibold text-gray-800 mb-2">Sustainability Program Manager</h4>
                  <p className="text-gray-600 mb-6 font-medium">Dec. 2021 – Dec. 2022 | Touch A Life Foundation Inc., California, USA (Remote)</p>
                  <ul className="space-y-4 text-gray-700">
                    <li className="flex items-start">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl font-bold text-gray-900 mb-16 text-center">Education</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-slate-50 to-gray-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-xl font-semibold text-gray-800 mb-4">MSc Economics</h4>
              <p className="text-gray-600">University of Birmingham, Birmingham, UK</p>
            </div>
            <div className="bg-gradient-to-br from-slate-50 to-gray-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-xl font-semibold text-gray-800 mb-4">Virtual Course in Applied Business Analytics</h4>
              <p className="text-gray-600">Indian School of Business, Hyderabad, India</p>
            </div>
            <div className="bg-gradient-to-br from-slate-50 to-gray-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-xl font-semibold text-gray-800 mb-4">BA in Liberal Arts</h4>
              <p className="text-gray-600">Economics Major, Political Science & Business Minors</p>
      ...
      <section id="projects" className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl font-bold text-gray-900 mb-16 text-center">Projects</h3>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-2xl font-semibold text-gray-800 mb-4">AnimeList Market Intelligence Dashboard</h4>
              <p className="text-blue-600 mb-6 font-medium">Power BI | 2024</p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <h4 className="text-2xl font-semibold text-gray-800 mb-4">Netflix Viewership & Content Strategy Analytics</h4>
              <p className="text-blue-600 mb-6 font-medium">Power BI, Excel | 2024</p>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section id="contact" className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <a href="tel:+917249388640" className="flex items-center text-gray-700 hover:text-blue-600 transition-colors">
              <span className="mr-2">📞</span> +91 7249388640
            </a>
            <a href="mailto:sowmya.vunnam@gmail.com" className="flex items-center text-gray-700 hover:text-blue-600 transition-colors">
              <span className="mr-2">✉️</span> sowmya.vunnam@gmail.com
            </a>
            <a href="https://linkedin.com/in/sowmyavunnam" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 hover:text-blue-600 transition-colors">
